...
//     // <td><input type="number" data-price="${price}" name="quantities[]" class="form-control input-sm product-quantity " min="1"></td>
//
//
//         var html =
//             `
//                 <tr>
//                     <td>${name}</td>
//                     <td><input type="number" data-price="${price}" name="products[${id}][quantity]" class="form-control input-sm product-quantity " min="1"></td>
//                     <td class="product-price">${price}</td>
//                     <td><button class="btn btn-danger btn-sm remove-product-btn" data-id="${id}"><span class="fa fa-trash"></span></button></td>
//                 </tr>
//             `;
